...
try {
    ...
    if (isset($pdo)) {
        ...
        $stmt->bindParam(':id', $user_id, PDO::PARAM_INT); // Use $order_id here
        $stmt->execute();
...
<body>
    ...
    <script>
        function cancelOrder(userId) {
            console.log('Cancel Order clicked for Order ID:', userId);
            ...
            if (confirm("Are you sure you want to cancel this order?")) {
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        alert("Order with ID " + userID + " has been canceled!");
