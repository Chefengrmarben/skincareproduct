...
<?php if (isset($_SESSION['login_type']) && $_SESSION['login_type'] == 2): ?>
        <div class="row">
          ...
          <hr>
          <?php 
              $status_arr = array("Preparing to Ship","Package Picked Up","Departed from Sorting Center","Arrive at Sorting Center","Left the Sorting Facility","Reached the Sorting Facility","Move out of Sorting Hub","Recieved at the Logistic Hub","Out for Delivery","Delivered","Delivery Attempt Unsuccessfull");
