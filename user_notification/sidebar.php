        ...
        <?php endif; ?>
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <?php 
              $status_arr = array("Preparing<br/>To Ship","Package Picked Up","Departed from <br/> Sorting Center","Arrived at<br/>Sorting Center","Left the<br/>Sorting Facility","Reached the <br/> Sorting Facility","Moved out of <br/> Sorting Hub","Received at <br/> the Logistics Hub","Out for Delivery","Delivered","Delivery Attempt <br/> Unsuccessfull");
