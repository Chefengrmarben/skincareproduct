...
Class Action {
	...
	function get_report(){
		...
		$status_arr = array("Preparing To Ship","Package Picked Up","Departed from Sorting Center","Arrive at the Sorting Center","Left the Sorting Facility","Reached the Sorting Facility","Moved out of the Sorting Hub","Received at the Logistics Hub","Out for Delivery","Delivered","Delivery Attempt Unsuccessfull");
