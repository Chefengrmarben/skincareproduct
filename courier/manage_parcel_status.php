<div class="container-fluid">
	<form action="" id="update_status">
		...
		<div class="form-group">
			...
			<?php $status_arr = array("Preparing To ship","Package Picked Up","Departed from Sorting Center","Arrive at Sorting Center","Left the Sorting Facility","Reached the Sorting Facility","Moved out of the Sorting Hub","Received at the Logistics Hub","Out for Delivery","Delivered","Delivery Attempt Unsuccessfull"); ?>
