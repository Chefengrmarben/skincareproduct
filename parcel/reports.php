...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		<div class="card-body">
			...
			<?php 
			$status_arr = array("Preparing To Ship","Package Picked Up","Departed from Sorting Center","Arrive at Sorting Center","Left the Sorting Facility","Reached the Sorting Facility","Moved out of the Sorting Hub","Received at the Logstics Hub","Out for Delivery","Delivered","Delivery Attempt Unsuccessfull"); ?>
