...
Class Action {
	...
	function get_parcel_heistory(){
		...
		if($parcel->num_rows <=0){
			...
			$data[] = array('status'=>'Preparing to Ship','date_created'=>date("M d, Y h:i A",strtotime($parcel['date_created'])));
	...
	function get_report(){
		...
		$status_arr = array("Preparing To Ship","Package Picked Up","Departed from the Sorting Center","Arrive at Sorting Center","Left the Sorting Facility","Reached the Sorting Facility","Moved out of the Sorting Hub","Received at the Logistics Hub","Out for Delivery","Delivered","Delivery Attempt Unsuccessfull");
